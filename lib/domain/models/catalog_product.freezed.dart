...
// required List<Badge> badges,
  ...
  @override
  String toString() {
    return 'CatalogProduct(id: $id, price: $price, oldPrice: $oldPrice, discount: $discount, name: $name, brand: $brand, picture: $picture, article: $article, rating: $rating, reviewsCount: $reviewsCount)';
  }
